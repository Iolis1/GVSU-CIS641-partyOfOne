...
<br />
<?php
// Retrieve most recent set of lab data
...
if (!$result) { // If there are no lab data recorded
    ...
    <br /><br />
    <!-- Add a button to view all lab summaries -->
    <a href='../../modules/custom_modules/summary_processor.php?patient_id=<?php echo attr($pid); ?>' onclick='top.restoreSession()'><?php echo xlt('View All Lab Summaries');?></a>
    </span>
    <?php
}
?>
